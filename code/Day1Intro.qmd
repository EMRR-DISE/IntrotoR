...
4.  Huge crowd-sourced base of packages and help. The R community is really what makes it special. Pretty much anything you want to do has probalby been done before, and there is a publicly available package to help you out.
...
Notice that as you start typing the function, a box pops up in RStudio that propts you with the arguments you might want to use.
