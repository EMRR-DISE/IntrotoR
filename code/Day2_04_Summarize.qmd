...
A common task scientists need to do is summarizing or aggregating a data set to get a clearer overview it. We'll start this lesson with some basic R functions for this task, and then move into some more powerful R functions from the [`dplyr`](https://dplyr.tidyverse.org/index.html) package to group and summarize your data.
